package com.hdos.rsyygh.loveflowerdemo.view;
...
import com.hdos.rsyygh.loveflowerdemo.R;

import java.util.Random;

/**
 * Created by xiaoyongbing on 2017/6/15.
 */

public class LoveLayout extends RelativeLayout {
    private Interpolator line = new LinearInterpolator();//以常量速率改变 线性
